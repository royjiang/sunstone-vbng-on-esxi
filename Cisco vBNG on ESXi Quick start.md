...
I am using a internal version of the image named xrv9k-full-x-6.3.1.13I.ova.
...
**[Comment]	In this step ,I set the name of the VM to `Cisco_IOS_XRv_9000_BNG_1`**
...
**[Comment]	No this step in my installation.**
...
**[Comment]	I am using the default option, Thick Provision Lazy Zeroed**
...
** [Comment]	My recommendation is not selecting it, since after the VM deployment completes, we need to add a console port with the VM powered down.**
...
**[Comment]	It takes around 30 minutes in my environment.**
...
> Step 1  
> Power-down the VM.
**[comment]	In my case the VM has not been powered on after deployment.**
> 
> Step 2  
...
**[Comment]	In my case it is set to [telnet://192.168.200.220:2001](telnet://192.168.200.220/2121)**
